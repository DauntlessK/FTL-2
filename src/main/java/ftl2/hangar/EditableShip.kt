...
import ftl2.ISystemConfiguration
import ftl2.f
import ftl2.game.InGameState
import ftl2.game.ShipBlueprint
...
import ftl2.systems.Weapons
import ftl2.weapons.AbstractWeaponBlueprint

/**
 * A ship that can be rendered in the hangar.
 *
 * This is kept separate from [ftl2.Ship], since what's desirable
